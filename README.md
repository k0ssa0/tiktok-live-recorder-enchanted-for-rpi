...
<h1> TikTok Live Recorder (Enchanted Version) 🎥</h1>

<em>An enhanced version of TikTok Live Recorder with additional custom features.</em>
...
- [x] <b>Support for M3U8:</b> Add support for recording live streams via m3u8 format.
...
This project is a fork of [tiktok-live-recorder](https://github.com/Michele0303/tiktok-live-recorder) created by **Michele0303**.
We thank the original author for the solid foundation.
